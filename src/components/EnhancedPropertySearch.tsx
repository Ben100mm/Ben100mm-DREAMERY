/**
 * Enhanced property search component using Pydantic models and improved session management
 * Demonstrates the new enhanced scraper capabilities
 */
...
import { Property, ScraperInput, ListingType, SearchPropertyType, ReturnType } from '../types/realtor';
  ...
  return (
    <Box sx={{ padding: '24px' }}>
      ...
      <Typography variant="body1" color="text.secondary" paragraph>
        Search for properties using Pydantic models and enhanced session management with improved reliability
      </Typography>
      ...
      <SearchContainer elevation={2}>
        ...
        <SearchForm>
          ...
          <TextField
            label="Last X Days"
            type="number"
            value={scraperInput.last_x_days || ''}
            onChange={(e) => setScraperInput(prev => ({ 
              ...prev, 
              last_x_days: e.target.value ? parseInt(e.target.value) : undefined 
            }))}
            placeholder="30"
            sx={{ width: '120px' }}
          />
          ...
          <FormControl sx={{ minWidth: '120px' }}>
            ...
            <Select
              ...
              label="Return Type"
            >
              <MenuItem value={ReturnType.PROPERTY}>Property</MenuItem>
              <MenuItem value={ReturnType.LISTING}>Listing</MenuItem>
        ...
        {loading && (
          <LoadingContainer>
            ...
            <Typography variant="body1" sx={{ ml: 2 }}>
              ...
              Searching with enhanced session management...
            </Typography>
          </LoadingContainer>
        )}
