...
interface Conversation {
  id: number;
  contactName: string;
  contactType: 'client' | 'buyer' | 'seller' | 'lender' | 'title-company' | 'broker' | 'general';
  organization: string;
  property?: string;
  lastMessage: string;
  timestamp: string;
...
const AgentMessages: React.FC = () => {
  ...
  const conversations: Conversation[] = [
    {
      ...
      lastMessage: 'I\'m ready to make an offer on the property. What\'s the next step?',
      timestamp: '10:30 AM',
      unread: 2,
      status: 'urgent',
      priority: 'high',
      ...
      topicOfDiscussion: 'Property Offer',
      joinDate: '2024-01-10',
    ...
    },
    {
      ...
      contactType: 'broker',
      organization: 'Wang Real Estate Brokerage',
      property: 'All Properties',
      lastMessage: 'The monthly sales report is ready for review. Great performance this month!',
      ...
      commissionRate: 'N/A',
      role: 'Broker',
      email: 'lisa.wang@wangrealestate.com',
      phone: '(555) 567-8901',
      dateOfContact: '2024-01-03',
      topicOfDiscussion: 'Monthly Sales Report',
      joinDate: '2024-01-01',
      verificationStatus: 'Verified',
    },
    {
  ...
  const sampleMessages: Message[] = [
    {
      id: 1,
      sender: 'contact',
      content: 'I\'m ready to make an offer on the property. What\'s the next step?',
      timestamp: '10:30 AM',
    },
    {
      id: 2,
      sender: 'agent',
      content: 'Great! I\'ll prepare the offer documents and submit them to the listing agent.',
      timestamp: '10:45 AM',
    },
    {
      id: 3,
      sender: 'contact',
      content: 'Perfect! What\'s the typical timeline for hearing back?',
      timestamp: '2:15 PM',
    },
  ];
  ...
  const getContactTypeIcon = (type: string) => {
    switch (type) {
      ...
      case 'buyer': return <HomeIcon sx={{ color: brandColors.actions.success }} />;
      case 'seller': return <BusinessIcon sx={{ color: brandColors.actions.warning }} />;
      ...
      case 'broker': return <GroupIcon sx={{ color: brandColors.actions.primary }} />;
    ...
    <Box sx={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ 
        ...
        <Typography variant="body1" sx={{ color: brandColors.text.secondary, mb: 3 }}>
          Manage communications with clients, buyers, sellers, and business partners
        </Typography>
                  ...
                  >
                    ...
                    >
                      <Typography 
                        variant="body1" 
                        sx={{ 
                          color: message.sender === 'agent' ? brandColors.text.inverse : brandColors.text.primary 
                        }}
                      >
                        {message.content}
                      </Typography>
