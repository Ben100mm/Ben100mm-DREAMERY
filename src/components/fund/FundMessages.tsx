...
interface Conversation {
  id: number;
  contactName: string;
  contactType: 'investor' | 'sponsor' | 'legal' | 'advisor' | 'bank' | 'lender' | 'due-diligence' | 'general';
  organization: string;
  project?: string;
  lastMessage: string;
  timestamp: string;
...
const FundMessages: React.FC = () => {
  ...
  // Mock conversations data for fundraising
  const conversations: Conversation[] = [
    {
      ...
      project: 'Austin Luxury Apartments Fund',
      lastMessage: 'I\'m interested in the fund details. Can we schedule a call?',
      timestamp: '2 hours ago',
      unread: 2,
      status: 'urgent',
      email: 'david.chen@chencapital.com',
      phone: '(555) 123-4567',
    ...
    },
    {
      ...
      contactType: 'investor',
      organization: 'Mitchell Family Office',
      project: 'Austin Luxury Apartments Fund',
      lastMessage: 'Due diligence documents received. Reviewing this week.',
      timestamp: '1 day ago',
      unread: 0,
      status: 'normal',
      email: 'sarah.mitchell@mitchellfo.com',
      phone: '(555) 234-5678',
      role: 'Investment Director',
      joinDate: '2023-03-20',
      verificationStatus: 'Accredited',
      dateOfContact: '2024-01-18',
      topicOfDiscussion: 'Due Diligence Process',
    ...
    },
    {
      ...
      project: 'Austin Luxury Apartments Fund',
      lastMessage: 'Legal documentation is ready for review.',
      timestamp: '2 days ago',
      unread: 1,
      status: 'normal',
      email: 'michael.rodriguez@rodriguezlegal.com',
      phone: '(555) 345-6789',
      role: 'Securities Attorney',
      joinDate: '2022-08-10',
      verificationStatus: 'Verified',
      dateOfContact: '2024-01-16',
      topicOfDiscussion: 'Legal Documentation & Compliance',
    ...
    },
    {
      ...
      contactType: 'advisor',
      organization: 'Kim Financial Advisors',
      project: 'Austin Luxury Apartments Fund',
      lastMessage: 'Client portfolio analysis complete. Ready to present.',
      timestamp: '3 days ago',
      unread: 0,
      status: 'normal',
      email: 'jennifer.kim@kimfinancial.com',
      phone: '(555) 456-7890',
    ...
    },
    {
      ...
      project: 'Austin Luxury Apartments Fund',
      lastMessage: 'Banking facilities approved. Documentation in progress.',
      ...
      topicOfDiscussion: 'Banking & Credit Facilities',
      investmentAmount: 'N/A',
      commitmentLevel: 'Service Provider',
    },
    {
      ...
      contactType: 'due-diligence',
      organization: 'Anderson Due Diligence Services',
      project: 'Austin Luxury Apartments Fund',
      lastMessage: 'Property inspection completed. Report available.',
      timestamp: '5 days ago',
      unread: 0,
      status: 'completed',
      email: 'lisa.anderson@andersondd.com',
      phone: '(555) 678-9012',
      role: 'Due Diligence Specialist',
      joinDate: '2023-01-22',
      verificationStatus: 'Verified',
      dateOfContact: '2024-01-10',
      topicOfDiscussion: 'Property Due Diligence',
      investmentAmount: 'N/A',
      commitmentLevel: 'Service Provider',
    },
  ];
  ...
  const messages: Message[] = [
    {
      id: 1,
      sender: 'contact',
      content: 'Hi, I\'m interested in learning more about your Austin Luxury Apartments Fund.',
      timestamp: '10:30 AM',
    },
    {
      id: 2,
      sender: 'sponsor',
      content: 'Thank you for your interest! I\'d be happy to discuss the investment opportunity with you. What questions do you have?',
      timestamp: '10:45 AM',
    },
    {
      id: 3,
      sender: 'contact',
      content: 'I\'m interested in the fund details. Can we schedule a call?',
      timestamp: '2:15 PM',
    },
  ];
  ...
  const getContactTypeIcon = (type: string) => {
    switch (type) {
      case 'investor': return <PersonIcon sx={{ color: brandColors.primary }} />;
      case 'sponsor': return <BusinessIcon sx={{ color: brandColors.actions.success }} />;
      case 'legal': return <GavelIcon sx={{ color: brandColors.actions.warning }} />;
      case 'advisor': return <TrendingUpIcon sx={{ color: brandColors.actions.info }} />;
      case 'bank': return <AccountBalanceIcon sx={{ color: brandColors.actions.error }} />;
      case 'lender': return <AccountBalanceIcon sx={{ color: brandColors.actions.primary }} />;
      case 'due-diligence': return <AssessmentIcon sx={{ color: brandColors.actions.success }} />;
  ...
  const tabCategories = [
    ...
    { label: 'Investor Communications', filter: 'investor' },
    { label: 'Project Sponsor', filter: 'sponsor' },
    { label: 'Legal & Compliance', filter: 'legal' },
    { label: 'Financial Advisor', filter: 'advisor' },
    { label: 'Bank/Lender', filter: 'bank' },
    { label: 'Due Diligence', filter: 'due-diligence' },
  ];
    ...
    <Box>
      ...
      >
        ...
        <Typography variant="body1" sx={{ color: 'rgba(255, 255, 255, 0.8)' }}>
          Manage communications with investors, advisors, and fundraising partners
        </Typography>
      </Paper>
                    ...
                    >
                      <Box
                        sx={{
                          ...
                          color: message.sender === 'sponsor' ? 'white' : 'text.primary',
                        }}
                      >
