...
interface Conversation {
  id: number;
  contactName: string;
  contactType: 'client' | 'advisor' | 'consultant' | 'specialist' | 'partner' | 'vendor' | 'general';
  organization: string;
  service?: string;
  lastMessage: string;
  timestamp: string;
...
const ProfessionalSupportMessages: React.FC = () => {
  ...
  const conversations: Conversation[] = [
    {
      ...
      lastMessage: 'I need help with my investment portfolio strategy. Can we schedule a consultation?',
      timestamp: '10:30 AM',
      unread: 2,
      status: 'urgent',
      priority: 'high',
      ...
      topicOfDiscussion: 'Investment Portfolio',
      joinDate: '2024-01-10',
    ...
    },
    {
      ...
      lastMessage: 'The tax optimization strategy has been implemented. Your savings should be significant.',
      timestamp: '9:15 AM',
      unread: 0,
      status: 'normal',
      priority: 'medium',
      ...
      email: 'michael.chen@chenfinancial.com',
      phone: '(555) 234-5678',
      dateOfContact: '2024-01-12',
      topicOfDiscussion: 'Tax Optimization',
      joinDate: '2024-01-08',
      verificationStatus: 'Verified',
    },
    {
      ...
      organization: 'Rodriguez Business Consulting',
      service: 'Business Strategy',
      lastMessage: 'The business plan review is complete. All recommendations have been implemented.',
      timestamp: 'Yesterday',
      unread: 1,
      status: 'completed',
      priority: 'low',
      ...
      email: 'emily.rodriguez@rodriguezconsulting.com',
      phone: '(555) 345-6789',
      dateOfContact: '2024-01-08',
      topicOfDiscussion: 'Business Plan Review',
      joinDate: '2024-01-05',
    ...
    },
    {
      ...
      organization: 'Thompson Legal Services',
      service: 'Legal Compliance',
      lastMessage: 'The compliance audit is complete. All legal requirements have been met.',
      ...
      email: 'david.thompson@thompsonlegal.com',
      phone: '(555) 456-7890',
      dateOfContact: '2024-01-05',
      topicOfDiscussion: 'Compliance Audit',
      joinDate: '2024-01-03',
      verificationStatus: 'Verified',
    },
    {
      ...
      contactType: 'partner',
      organization: 'Wang Technology Partners',
      service: 'Technology Integration',
      lastMessage: 'The system integration is complete. All systems are working seamlessly.',
      ...
      email: 'lisa.wang@wangtech.com',
      phone: '(555) 567-8901',
      dateOfContact: '2024-01-03',
      topicOfDiscussion: 'System Integration',
      joinDate: '2024-01-01',
      verificationStatus: 'Verified',
    },
    {
      ...
      contactType: 'vendor',
      organization: 'Johnson Marketing Services',
      service: 'Marketing Strategy',
      lastMessage: 'The marketing campaign has been launched. Initial results look promising.',
      ...
      email: 'robert.johnson@johnsonmarketing.com',
      phone: '(555) 678-9012',
      dateOfContact: '2023-12-28',
      topicOfDiscussion: 'Marketing Campaign',
      joinDate: '2023-12-25',
      verificationStatus: 'Verified',
    },
  ];
  ...
  const sampleMessages: Message[] = [
    {
      id: 1,
      sender: 'contact',
      content: 'I need help with my investment portfolio strategy. Can we schedule a consultation?',
      timestamp: '10:30 AM',
    },
    {
      id: 2,
      sender: 'support',
      content: 'Absolutely! I\'d be happy to help you optimize your investment portfolio. When would work best for you?',
      timestamp: '10:45 AM',
    },
    {
      id: 3,
      sender: 'contact',
      content: 'How about next Tuesday at 2 PM? I can meet in person or via video call.',
      timestamp: '2:15 PM',
    },
  ];
  ...
  const getContactTypeIcon = (type: string) => {
    switch (type) {
      ...
      case 'advisor': return <AssessmentIcon sx={{ color: brandColors.actions.success }} />;
      case 'consultant': return <BusinessIcon sx={{ color: brandColors.actions.warning }} />;
      case 'specialist': return <SecurityIcon sx={{ color: brandColors.actions.info }} />;
      case 'partner': return <GroupIcon sx={{ color: brandColors.actions.error }} />;
      case 'vendor': return <AccountBalanceIcon sx={{ color: brandColors.actions.primary }} />;
  ...
  const getContactTypeLabel = (type: string) => {
    switch (type) {
      ...
      case 'consultant': return 'Business Consultant';
    ...
    <Box sx={{ height: '100vh', display: 'flex', flexDirection: 'column' }}>
      ...
      <Box sx={{ 
        ...
        <Typography variant="body1" sx={{ color: brandColors.text.secondary, mb: 3 }}>
          Manage communications with clients, advisors, consultants, and professional service providers
        </Typography>
                  ...
                  >
                    ...
                    >
                      <Typography 
                        variant="body1" 
                        sx={{ 
                          color: message.sender === 'support' ? brandColors.text.inverse : brandColors.text.primary 
                        }}
                      >
                        {message.content}
                      </Typography>
            ...
            <Box sx={{ mb: 3 }}>
              ...
              <Box sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
                <Box>
                  ...
                  <Typography variant="body2">{selectedConv.service}</Typography>
                </Box>
                <Box>
                ...
                <Box>
                  ...
                  <Typography variant="body2">{selectedConv.expertise}</Typography>
                </Box>
                <Box>
