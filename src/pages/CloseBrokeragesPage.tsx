      ...
      >
        ...
        {state.activeTab === 'agents' && (
          <>
            ...
            <Box sx={{ pl: 0, ml: 3 }}>
              <Typography variant="h6">Agent Management Content</Typography>
              <Typography variant="body1">This section will contain agent management tools and features.</Typography>
            </Box>
          </>
        )}
