...
const PreApprovalPropertyFinancialPage: React.FC = () => {
  ...
  const handleBack = () => {
    navigate('/pre-approval-financial', { state: { answers: location.state?.answers } });
  };
  ...
  const handleNext = () => {
    ...
    navigate('/pre-approval-additional-questions', { state: { answers: allData } });
  };
          ...
          <QuestionCard>
            <CardContent sx={{ p: { xs: 1.5, md: 3 }, flex: 1, overflow: 'auto' }}>
              ...
              <Typography variant="body2" sx={{ color: '#666', mb: 4, textAlign: 'center' }}>
                Help us understand your property preferences and financial situation to provide accurate estimates.
              </Typography>
              ...
              >
                <MenuItem value="" disabled>Select credit score range *</MenuItem>
