...
const SellListHomeDetailsPage: React.FC = () => {
  ...
  const { address, sellChecked, listChecked, movingDetails, sellTiming, listTiming } = location.state || {};
  ...
  const handleBack = () => {
    navigate('/sell-moving-details-2', {
      state: { address, sellChecked, listChecked, movingDetails, sellTiming, listTiming },
    });
  };
  ...
  return (
    <PageContainer>
      ...
      <MainContent>
        <ContentWrapper>
          <Typography variant="h5" sx={{ fontWeight: 800, color: '#1a365d', mb: 1 }}>
          ...
          <CounterRow label="Full bathrooms" value={fullBaths} onChange={setFullBaths} />
          <CounterRow label="3/4 bathrooms" value={threeQuarterBaths} onChange={setThreeQuarterBaths} />
          <CounterRow label="1/2 bathrooms" value={halfBaths} onChange={setHalfBaths} />
          <CounterRow label="Floors (above ground)" value={floors} onChange={setFloors} />
        </ContentWrapper>

        <ImageContainer>
          <img src={process.env.PUBLIC_URL + '/home-details-1.png'} alt="Home details" />
        </ImageContainer>
      </MainContent>
