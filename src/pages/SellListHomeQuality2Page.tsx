...
const SellListHomeQuality2Page: React.FC = () => {
  ...
  const handleNext = () => {
    if (!selected) return;
    navigate("/sell-home-quality-3", {
      state: { ...prevState, homeQuality2: selected },
    });
  };
  const handleBack = () => {
    navigate("/sell-home-quality", { state: prevState });
  };
...
export default SellListHomeQuality2Page;
