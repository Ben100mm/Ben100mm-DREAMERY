...
const SellListHomeQuality3Page: React.FC = () => {
  ...
  const handleNext = () => {
    if (!selected) return;
    navigate("/sell-home-quality-4", {
      state: { ...prevState, homeQuality3: selected },
    });
  };
  const handleBack = () => {
    navigate("/sell-home-quality-2", { state: prevState });
  };
    ...
    <PageContainer>
      ...
      <MainContent>
        <ContentWrapper>
          ...
          >
            How would you describe your main bathroom?
          </Typography>
...
export default SellListHomeQuality3Page;
