...
const SellListHomeQualityPage: React.FC = () => {
  ...
  const handleNext = () => {
    if (!selected) return;
    navigate("/sell-home-quality-2", {
      state: { ...prevState, homeQuality: selected },
    });
  };
  const handleBack = () => {
    navigate("/sell-home-details-3", { state: prevState });
  };
...
export default SellListHomeQualityPage;
