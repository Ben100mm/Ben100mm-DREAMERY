  ...
  const renderFilterContent = () => {
    switch (activeFilter) {
      case 'property-type':
        return (
          <Box>
            <Typography variant="h6" sx={{ mb: 2 }}>Property Type</Typography>
            <RadioGroup value={propertyType} onChange={(e) => setPropertyType(e.target.value)}>
              ...
              <FormControlLabel value="land" control={<Radio />} label="Land/Lot" />
              <FormControlLabel value="investment" control={<Radio />} label="Investment Property" />
            </RadioGroup>
            <Box sx={{ mt: 2 }}>
        ...
        return (
          <Box>
            ...
            <RadioGroup value={listingType} onChange={(e) => setListingType(e.target.value)}>
              ...
              <FormControlLabel value="fsbo" control={<Radio />} label="For Sale by Owner" />
            </RadioGroup>
            <Box sx={{ mt: 2 }}>
              <Button variant="contained" fullWidth onClick={handleCloseFilter}>
                Apply
      ...
      case 'urgency':
        return (
          <Box>
            <Typography variant="h6" sx={{ mb: 2 }}>Urgency Level</Typography>
            <RadioGroup value={urgency} onChange={(e) => setUrgency(e.target.value)}>
              <FormControlLabel value="standard" control={<Radio />} label="Standard (30-90 days)" />
              <FormControlLabel value="quick" control={<Radio />} label="Quick Sale (15-30 days)" />
              <FormControlLabel value="urgent" control={<Radio />} label="Urgent (7-15 days)" />
              <FormControlLabel value="asap" control={<Radio />} label="ASAP (3-7 days)" />
            </RadioGroup>
            <Box sx={{ mt: 2 }}>
              <Button variant="contained" fullWidth onClick={handleCloseFilter}>
                Apply
        ...
        <Container maxWidth="xl">
          <Box sx={{ display: 'flex', alignItems: 'center', gap: 2, flexWrap: 'wrap' }}>
            <FilterButton
              ...
              endIcon={activeFilter === 'property-type' ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
            >
              Property Type
            </FilterButton>
            ...
            <FilterButton
              ...
              endIcon={activeFilter === 'property-status' ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
            >
              Property Status
            </FilterButton>
            ...
            <FilterButton
              ...
              endIcon={activeFilter === 'price-range' ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
            >
              Price Range
            </FilterButton>
            ...
            <FilterButton
              ...
              endIcon={activeFilter === 'urgency' ? <KeyboardArrowUp /> : <KeyboardArrowDown />}
            >
              Urgency
            </FilterButton>
          </Box>
      ...
      <Container maxWidth="xl" sx={{ py: 4 }}>
        <Box sx={{ mb: 4 }}>
          ...
          <Typography variant="body1" sx={{ color: '#666', mb: 3 }}>
            Select the service that best fits your needs. Our professionals will help you get the best value for your property.
          </Typography>
        </Box>
            ...
            <Box key={service.id}>
              ...
              >
                <CardContent sx={{ p: 3, textAlign: 'center' }}>
                  ...
                  <Box sx={{ mb: 2 }}>
                    <Typography variant="subtitle2" sx={{ fontWeight: 600, color: '#1a365d' }}>
                      What's included:
                    </Typography>
                    <Box sx={{ mt: 1 }}>
                  ...
                  <Box sx={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                    ...
                    <Button
                      ...
                      size="small"
                      sx={{
                        backgroundColor: selectedService === service.id ? '#1a365d' : 'transparent',
                        color: selectedService === service.id ? 'white' : '#1a365d',
                        borderColor: '#1a365d',
                        '&:hover': {
                          backgroundColor: selectedService === service.id ? '#0d2340' : '#f8f9fa',
                        }
                      }}
                    >
        ...
        {selectedService && (
          <Box sx={{ mt: 4, p: 3, bgcolor: 'white', borderRadius: 2, border: '1px solid #e0e0e0' }}>
