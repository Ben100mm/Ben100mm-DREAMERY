...
const SellListServicesPage: React.FC = () => {
  ...
  const agentFeesRange = [
    ...
    Math.round(estimatedValue * 0.06),
  ];
  const closingCosts = Math.round(estimatedValue * 0.01);
  const cashProceedsRange = [
    estimatedValue - agentFeesRange[1] - closingCosts,
    estimatedValue - agentFeesRange[0] - closingCosts,
  ];
      ...
      <MainContent>
        ...
        <Card sx={{ border: "2px solid brandColors.primary", borderRadius: 3, mb: 3 }}>
          <CardContent sx={{ p: 3 }}>
            ...
            <Box sx={{ display: "flex", alignItems: "center", mb: 2 }}>
              <Typography
                variant="h4"
                sx={{ fontWeight: 800, color: "#22c55e", mr: 2 }}
              >
            ...
            <Box
              sx={{ backgroundColor: "#f0f9ff", p: 2, borderRadius: 2, mb: 3 }}
            >
              <Typography
                variant="body2"
            ...
            <Box
              sx={{ backgroundColor: "#f8fafc", p: 2, borderRadius: 2, mb: 3 }}
            >
              <Typography
                variant="body2"
                sx={{ color: brandColors.primary, fontWeight: 500 }}
            ...
            <Box
              sx={{ backgroundColor: "#f8fafc", p: 3, borderRadius: 3, mb: 3 }}
            >
        ...
        <Box sx={{ mb: 4 }}>
          ...
          >
            ...
            <Typography variant="body1" sx={{ fontWeight: 600 }}>
              ${marketValueRange[0].toLocaleString()} - $
              {marketValueRange[1].toLocaleString()}
            </Typography>
          </Box>
          ...
          >
            ...
            <Typography variant="body1" sx={{ fontWeight: 600 }}>
              ${agentFeesRange[0].toLocaleString()} - $
              {agentFeesRange[1].toLocaleString()}
            </Typography>
          </Box>
          ...
          >
            ...
            <Typography variant="h6" sx={{ fontWeight: 700, color: "#22c55e" }}>
              ${cashProceedsRange[0].toLocaleString()} - $
              {cashProceedsRange[1].toLocaleString()}
            </Typography>
          </Box>
        </Box>
        ...
        <Box sx={{ mt: 4, p: 3, backgroundColor: "#fef3c7", borderRadius: 3 }}>
          ...
          <Typography variant="body2" sx={{ color: "#92400e", mb: 2 }}>
            Get your Showcase listing completely free when you sell with a
            Dreamery partner agent. This premium feature normally costs $299 and
            includes:
          </Typography>
