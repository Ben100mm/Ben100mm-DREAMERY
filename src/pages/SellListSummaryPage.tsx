...
const SellListSummaryPage: React.FC = () => {
  ...
  const renderEditableField = (
    ...
    value: any,
    fieldPath: string,
    type: "text" | "select" | "radio" | "checkbox" = "text",
    options?: any[],
  ) => {
            ...
            <Box sx={{ display: "flex", gap: 1 }}>
              {type === "text" && (
                <TextField
                  ...
                  onChange={(e) =>
                    setEditedData(
                      setValueByPath(editedData, fieldPath, e.target.value),
                    )
                  }
                  sx={{ minWidth: 200 }}
                />
            ...
            <CardContent>
              {renderEditableField(
                ...
                [
                  ...
                  {
                    value: "working-with-agent",
                    label: "Working with an agent",
                  },
                  {
                    value: "signed-agreement",
                    label: "Signed agreement with agent",
                  },
                ],
              )}
              {renderEditableField(
                "Timing",
                sellTiming || listTiming,
                "sellTiming",
                "select",
                [
        ...
        <SummarySection>
          ...
          <SummaryCard>
            <CardContent>
              {renderEditableField(
                "Home Type",
                getValueByPath(formData, "homeDetails.homeType"),
                "homeDetails.homeType",
              )}
              {renderEditableField(
                "Square Footage",
                getValueByPath(formData, "homeDetails.squareFeet"),
                "homeDetails.squareFeet",
              )}
              {renderEditableField(
                "Year Built",
                getValueByPath(formData, "homeDetails.yearBuilt"),
                "homeDetails.yearBuilt",
              )}
              {renderEditableField(
                "Bedrooms",
                getValueByPath(formData, "homeDetails.bedrooms"),
                "homeDetails.bedrooms",
              )}
              {renderEditableField(
                "Full Bathrooms",
                getValueByPath(formData, "homeDetails.fullBaths"),
                "homeDetails.fullBaths",
              )}
              {renderEditableField(
                "Floors",
                getValueByPath(formData, "homeDetails.floors"),
                "homeDetails.floors",
              )}
              {renderEditableField(
                "Pool Type",
                getValueByPath(formData, "homeDetails2.poolType"),
                "homeDetails2.poolType",
                "select",
                [
                  { value: "", label: "" },
                  { value: "No", label: "No" },
              ...
              {renderEditableField(
                "Garage Spaces",
                getValueByPath(formData, "homeDetails2.garageSpaces"),
                "homeDetails2.garageSpaces",
              )}
              {renderEditableField(
                "Carport Spaces",
                getValueByPath(formData, "homeDetails2.carportSpaces"),
                "homeDetails2.carportSpaces",
              )}
              {renderEditableField(
                "Has Basement",
                getValueByPath(formData, "homeDetails3.hasBasement"),
                "homeDetails3.hasBasement",
                "radio",
                [
                  { value: "yes", label: "Yes" },
                  { value: "no", label: "No" },
              ...
              {getValueByPath(formData, "homeDetails3.hasBasement") ===
                ...
                <>
                  {renderEditableField(
                    "Basement Use",
                    getValueByPath(formData, "homeDetails3.basementUse"),
                    "homeDetails3.basementUse",
                    "select",
                    [
                      { value: "Not Functional", label: "Not Functional" },
                      { value: "For Storage", label: "For Storage" },
                      {
                        value: "Fully Functional and Furnishable",
                        label: "Fully Functional and Furnishable",
                      },
                    ],
                  )}
                  {renderEditableField(
                    "Knows Square Footage",
                    getValueByPath(formData, "homeDetails3.knowsSqft"),
                    "homeDetails3.knowsSqft",
                    "radio",
                    [
                      { value: "yes", label: "Yes" },
                      { value: "no", label: "No" },
                  ...
                  {getValueByPath(formData, "homeDetails3.knowsSqft") ===
                    ...
                    <>
                      {renderEditableField(
                        "Finished Area (sqft)",
                        getValueByPath(formData, "homeDetails3.finishedSqft"),
                        "homeDetails3.finishedSqft",
                      )}
                      {renderEditableField(
                        "Unfinished Area (sqft)",
                        getValueByPath(formData, "homeDetails3.unfinishedSqft"),
                        "homeDetails3.unfinishedSqft",
                      )}
                    </>
                  )}
                </>
