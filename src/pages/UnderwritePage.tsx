...
const UnderwritePage: React.FC = () => {
  ...
  return (
    <Box sx={{ p: 3 }}>
      <Typography variant="h4" gutterBottom sx={{ color: brandColors.primary, fontWeight: 700 }}>
        Loan Underwriting
      </Typography>
      <Typography variant="body1" color="text.secondary" paragraph>
        Comprehensive loan evaluation and risk assessment tools
      </Typography>
              ...
              <Card key={`underwrite-placeholder-${index}`} sx={{ 
                ...
                <CardContent>
                  ...
                  <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                    ...
                    <Typography variant="body2" color="text.secondary">
                      {['Los Angeles, CA', 'New York, NY', 'Chicago, IL', 'Miami, FL', 'Seattle, WA', 'Austin, TX', 'Denver, CO', 'Phoenix, AZ'][index]}
                    </Typography>
                  </Box>
