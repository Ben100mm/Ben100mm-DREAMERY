          ...
          <Grid item xs={12} sm={6} md={4} lg={3} key={`mortgage-placeholder-${index}`}>
            <Card sx={{ 
              ...
              <CardMedia
                component="img"
                height="200"
                image={`https://via.placeholder.com/300x200/1a365d/ffffff?text=Mortgage+Option+${index + 1}`}
                alt={`Mortgage Option ${index + 1}`}
                sx={{ objectFit: 'cover' }}
              />
              <CardContent>
                ...
                <Typography variant="h5" sx={{ color: '#2d3748', fontWeight: 700, mb: 1 }}>
                  {(3.5 + index * 0.25).toFixed(2)}% APR
                </Typography>
                
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                  <LocationOn sx={{ color: '#718096', fontSize: 20, mr: 1 }} />
                  <Typography variant="body2" color="text.secondary">
                    {['Conventional', 'FHA', 'VA', 'USDA', 'Jumbo', 'Conforming', 'Non-Conforming', 'Fixed Rate', 'Adjustable Rate', 'Interest Only'][index]}
                  </Typography>
                </Box>
                ...
                <Box sx={{ display: 'flex', alignItems: 'center', mb: 2 }}>
                  <Box sx={{ display: 'flex', alignItems: 'center', mr: 2 }}>
                    <Typography variant="body2" color="text.secondary">
                      ${(300000 + index * 50000).toLocaleString()} max
                    </Typography>
                  </Box>
                  <Box sx={{ display: 'flex', alignItems: 'center', mr: 2 }}>
                    <Typography variant="body2" color="text.secondary">
